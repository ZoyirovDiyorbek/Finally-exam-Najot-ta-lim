      ...
      <Card className="w-full max-w-137.5 border-none shadow-sm rounded-2xl py-12 px-6">
        <CardContent className="flex flex-col items-center text-center space-y-6">
          ...
          <div className="flex items-center gap-1 mb-2">
            <h1 className="text-6xl font-black tracking-tighter text-gray-900">HMHY</h1>
          </div>
          ...
          <Button 
            className="w-full max-w-95 h-12 bg-emerald-500 hover:bg-emerald-600 transition-opacity rounded-lg text-[15px] font-semibold cursor-pointer"
          ...
          <p className="text-[13px] text-gray-500 max-w-87.5 leading-snug">
